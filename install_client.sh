...
app_link="https://github.com/fantopop/usbserver-agent/releases/download/v1.0/rhcl.RUN.THIS.APP.zip"
...
then
	...
	echo "rhcl client is not installed, download from https://archive.nio-electronics.ru/?dir=client/macOS"
    exit 1
fi
